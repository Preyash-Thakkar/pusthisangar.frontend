...
const MidFooter = () => {
  const { getCategories, getLoggedInCustomer } = useContext(SignContext);
  const [CategoryData, setCategoryData] = useState([]);
  const authToken = localStorage.getItem("authToken");
  const [CustomerInfo, setCustomerInfo] = useState({});
  const openGoogleMaps = () => {
    window.open(
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.326428163956!2d73.17078387533668!3d22.30349117968429!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395fc8aee6cfffff%3A0xc5da2624cf914dc5!2sPushtishangar!5e0!3m2!1sen!2sin!4v1704121065327!5m2!1sen!2si"
    );
  };
  ...
  const openInstagram = () => {
    window.open(
      "https://www.instagram.com/pushtishangar/?igsh=MXNwZjFvMXkwNDA0dg%3D%3D"
    );
  };
  const openPintrest = () => {
    window.open(
      "https://www.pinterest.com/pushtishangar/?invite_code=79dd065f0f1144c284a9e615b38a7eef&sender=1101552527515708041"
    );
  };
  const openYoutube = () => {
      ...
      <section className="section-padding footer-mid bg-dark ">
        <div className="container pt-15 pb-20">
          <div className="row">
                ...
                <ul className="contact-infor list-unstyled text-start">
                  ...
                  <li className="text-start d-flex jusify-content-start">
                    <div className="mobile-social-icon ">
                      ...
                      <Link onClick={openInstagram} className="text-dark">
                        <FaInstagram />
                      </Link>
                      <Link onClick={openPintrest} className="text-dark">
                        <FaPinterest />
                      </Link>
                      <Link onClick={openYoutube} className="text-dark">
                        <FaYoutube />
                      </Link>
                    </div>
                  </li>
            ...
            <Col sm="12" md="6" lg="2" className="footer-link-widget col-lg">
            ...
            <Col
              ...
              md="6"
              lg="2"
              className="footer-link-widget costomer-block col-lg"
            >
        ...
        <div className="container  ">
          <div className="row ">
            <div className="d-flex justify-content-between lh-base mb-3 footer-text align-items-center">
              <div>
                <p className="font-sm mb-0 text-white text-start d-block">
                  Copyright © 2023,
