...
import image1 from "../../images/smallsanagr.jpg";
          ...
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center inovice-mobile ">
                ...
                <Link to="print-statement" class="print-order">
                  Print Order
                </Link>{" "}
              </h3>
            </div>
                  ...
                  <table className="meta table table-bordered">
                    <tbody className="text-start">
                      ...
                      <tr>
                        ...
                        <td>Online - CCAvenue - Debit Card</td>
                      </tr>
                      <tr>
                        <th>Shipping Method </th>
                        <td>
                          Weight Based Shipping (Weight:1.000 Kg ) - ? 59.000( 3
                          to 6 working days delivery )
                        </td>
                      </tr>
                    </tbody>
                  </table>
                    ...
                    <table className="meta-1 table table-bordered order-summary mb-0">
                      <tbody className="text-start">
                        ...
                        <tr>
                          ...
                          <td>₹ 142.86</td>
                          <td className="text-center">1</td>
                          <td className="text-end">₹ 142.86</td>
                        </tr>
                        <tr>
                          ...
                          <td>₹ 161.90</td>
                          <td className="text-center">1</td>
                          <td className="text-end">₹ 161.90</td>
                        </tr>
                        <tr>
                          ...
                          <td className="text-end">₹ 304.76</td>
                        </tr>
                        <tr id>
                          <td colSpan={4} className="text-left" />
                          <td colSpan={2} className="text-end fw-bold">
                        ...
                        <tr id>
                          ...
                          <td className="text-end">₹ 15.24</td>
                        </tr>
                        <tr>
                          <td colSpan={6} className="text-end">
                            <p className="text-left fw-bold">
                              <span className="text-color fs-13">*</span> ^
                              Order Item Weight or Price Modified Signs
                            </p>
                            <p className="fw-bold text-end mb-0 d-block">
                              Weight Based Shipping (Weight:1.000 Kg) - ? 59.000
                              (3 to 6 working days delivery) (+) :
                            </p>
                          </td>
                          <td className="text-end">₹ 59.00</td>
                        </tr>
                        <tr>
                          <td colSpan={4} className="text-left" />
                          <td colSpan={2} className="text-end fw-bold">
                        ...
                        <tr>
                          ...
                          <td className="text-end">₹ 379.00</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
